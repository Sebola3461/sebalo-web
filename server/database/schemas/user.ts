  ...
  twitch_options: {
    ...
    default: {
      ...
      messages: {
        ...
        invalid_status: "The streamer only accept {beatmap_status} beatmaps.",
        bad_sr:
          "The streamer does not accept this sr (min: {sr_min} {separator} max: {sr_max}).",
        request: "{username} {separator}{separator} {mode} {beatmap}",
      },
      modes: [0, 1, 2, 3],
      blacklist: [],
      status: ["ranked", "wip", "graveyard", "pending", "loved", "qualified"],
    },
  },
  osu: {
    access_token: "",
